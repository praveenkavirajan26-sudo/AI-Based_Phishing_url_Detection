...
import { ShieldAlert, LogOut, User, LayoutDashboard, Search, PieChart, Moon, Sun, Shield } from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="app-shell min-h-screen bg-black text-white font-sans flex flex-col relative overflow-hidden transition-colors duration-300">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            <button
              ...
              className="theme-toggle flex items-center justify-center w-10 h-10 rounded-lg border border-gray-800 bg-gray-800 text-gray-300 hover:text-white hover:bg-gray-700 transition-colors"
              aria-label={isLightMode ? 'Switch to dark mode' : 'Switch to light mode'}
              title={isLightMode ? 'Dark mode' : 'White mode'}
            >
              ...
              <>
                ...
                {isAdmin && (
                  <button
                    ...
                    className={`flex items-center space-x-2 px-3 py-2 rounded-lg transition-colors font-mono tracking-wide ${currentView === 'admin' ? 'bg-gray-800 text-neonBlue' : 'text-gray-400 hover:text-white'}`}
                  >
      ...
      <main className="flex-grow flex flex-col items-center">
        ...
        {currentView === 'auth' && <Auth setToken={setToken} setCurrentView={setCurrentView} setUsername={setUsername} setIsAdmin={setIsAdmin} />}
        ...
        {currentView === 'admin' && (
          isAdmin ? (
            ...
            <div className="w-full max-w-6xl mx-auto p-4 sm:p-6 lg:p-8 animate-fade-in relative z-10">
              <Alert message="Unauthorized access. Admin privileges required." type="error" />
            </div>
          )
        )}
      </main>
